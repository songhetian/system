...
export async function initLeaveQuota(year, employeeIds) {
...
export async function findLeaveQuotaByFilter(params) {
...
export async function findLeaveQuotaById(id) {
...
export async function updateLeaveQuota(id, data) {
    const quota = await prisma.leaveQuota.findUnique({
        where: { id },
    });
    if (!quota) {
...
export async function deductLeaveQuota(data, tx) {
...
//# sourceMappingURL=leave-quota.service.js.map