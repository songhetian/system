...
export const zTrainingCourseCreate = z.object({
...
export const zTrainingCourseUpdate = zTrainingCourseCreate.partial();

export const zTrainingCourse = zTrainingCourseCreate
  .extend({
