import { z } from 'zod';
import { zEmployeeContractCreate, zEmployeeContractUpdate, zEmployeeContract, zEmployeeDocumentCreate, zEmployeeDocument, zEmployeeEventCreate, zEmployeeEvent, } from '@shop/shared';
import { createResponseSchema, zodToSchema } from '../utils/zod-to-schema.js';
import { createEmployeeContract, listEmployeeContracts, getEmployeeContract, updateEmployeeContract, terminateEmployeeContract, createEmployeeDocument, listEmployeeDocuments, getEmployeeDocument, verifyEmployeeDocument, deleteEmployeeDocument, createEmployeeEvent, listEmployeeEvents, getEmployeeEvent, getEmployeeArchive, } from '../services/employee-archive.service.js';
// ponytail: Prisma Date → schema 期望的 ISO datetime / date string
function toContractView(c) {
    return {
        ...c,
...
export const employeeArchiveRoutes = async (app) => {
...
//# sourceMappingURL=employee-archive.js.map