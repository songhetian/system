...
export const zLeaveRequestCreateBase = z.object({
  employeeId: z.number().int().positive(),
  type: zLeaveType,
...
export const zLeaveRequestCreate = zLeaveRequestCreateBase.superRefine((data, ctx) => {
  // 结束日期不能早于开始日期
...
export const zLeaveRequestUpdate = zLeaveRequestCreateBase.partial();
...
export const zLeaveRequestBase = zLeaveRequestCreateBase
  .extend({
    id: z.number().int().positive(),
