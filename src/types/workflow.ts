...
export const zTemplateNode = z.discriminatedUnion("type", [
  ...
  zBaseNode.extend({
    ...
    signType: zSignType,
    timeoutHours: z.number().positive().nullable().default(null),
    timeoutAction: zTimeoutAction.nullable().default(null),
  }),
  // CONDITION
  zBaseNode.extend({
...
export const zWorkflowTemplateCreate = z.object({
...
export const zWorkflowTemplate = zWorkflowTemplateCreate
  .extend({
