import { z } from 'zod';
import { zAttendanceRecordCreate, zAttendanceRecord, zAttendanceRecordQuery, zAttendanceSummaryGenerate, zAttendanceSummary, zAttendanceSummaryQuery, } from '@shop/shared';
import { createResponseSchema, createPaginatedResponseSchema, zodToSchema } from '../utils/zod-to-schema.js';
import { clock, findByFilter as findRecordsByFilter, findById as findRecordById, } from '../services/attendance-record.service.js';
import { generate, findByFilter as findSummariesByFilter, findById as findSummaryById, lock, unlock, } from '../services/attendance-summary.service.js';
export const attendanceRoutes = async (app) => {
    ...
    app.post('/attendance-records/clock', {
        schema: {
            description: '打卡',
            tags: ['考勤'],
    ...
    app.post('/attendance-summaries/generate', {
        schema: {
    ...
    app.get('/attendance-summaries/:id', {
        schema: {
    ...
    app.post('/attendance-summaries/:id/lock', {
        schema: {
            description: '锁定考勤台账',
            tags: ['考勤'],
            params: zodToSchema(z.object({ id: z.coerce.number().int().positive() })),
    ...
    app.post('/attendance-summaries/:id/unlock', {
        schema: {
            description: '解锁考勤台账',
            tags: ['考勤'],
            params: zodToSchema(z.object({ id: z.coerce.number().int().positive() })),
