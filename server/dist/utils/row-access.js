...
// 获取部门及其所有子部门的 ID 列表
export async function getDepartmentAndChildrenIds(deptId) {
 ...
 */
export async function buildRowAccessFilter(ctx, entity) {
    // 超级管理员：无过滤
...
function buildOwnFilter(entity, employeeId) {
    switch (entity) {
        case 'employee':
...
function buildDepartmentFilter(entity, deptIds) {
...
//# sourceMappingURL=row-access.js.map