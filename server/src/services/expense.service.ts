...
export async function createExpenseClaim(data: ExpenseClaimCreate, employeeId: number) {
...
export async function updateExpenseClaim(id: number, data: ExpenseClaimUpdate) {
...
export async function submitExpenseClaim(id: number) {
  return prisma.expenseClaim.update({
    where: { id },
    data: { status: 'PENDING' },
  });
...
export async function rejectExpenseClaim(id: number) {
  return prisma.expenseClaim.update({
    where: { id },
