import { z } from 'zod';
import { zExpenseClaimCreate, zExpenseClaimUpdate, zExpenseClaim, zExpenseClaimQuery, } from '@shop/shared';
import { createResponseSchema, createPaginatedResponseSchema, zodToSchema } from '../utils/zod-to-schema.js';
import { createExpenseClaim, getExpenseClaimById, listExpenseClaims, updateExpenseClaim, submitExpenseClaim, approveExpenseClaim, rejectExpenseClaim, } from '../services/expense.service.js';
...
export const expenseRoutes = async (app) => {
    ...
    app.post('/claims', {
        ...
        try {
            ...
            const employeeId = request.employeeId ?? request.user?.employeeId ?? 1;
