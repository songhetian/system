...
import {
  ...
  updateShiftTemplate,
  deleteShiftTemplate,
} from '../services/shift-template.service.js';
import {
  createRotationRule,
  ...
  updateRotationRule,
  deleteRotationRule,
} from '../services/rotation-rule.service.js';
import {
  createSchedule,
...
import {
  ...
  checkBatchScheduleConstraints,
} from '../services/schedule-constraints.service.js';
import type { ConstraintConfig } from '../services/schedule-constraints.service.js';
import {
  createScheduleTemplateFromHistory,
  applyScheduleTemplate,
  listScheduleTemplates,
  getScheduleTemplate,
  deleteScheduleTemplate,
} from '../services/schedule-template.service.js';
...
export const scheduleRoutes: FastifyPluginAsync = async (app) => {
  ...
  const zConstraintCheckBody = z.object({
    ...
    date: z.string(),
    config: z.custom<Partial<ConstraintConfig>>().optional(),
  });
  ...
  app.post(
    ...
    async (request) => {
      ...
      const data = await checkScheduleConstraints(
        body.employeeId,
  ...
  app.post(
    ...
    async (request) => {
      ...
      const data: Record<string, z.infer<typeof zConstraintViolation>[]> = {};
