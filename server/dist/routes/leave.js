import { z } from 'zod';
import { zLeaveQuotaInit, zLeaveQuota, zLeaveQuotaQuery, zLeaveRequestCreate, zLeaveRequestUpdate, zLeaveRequestListItem, zLeaveRequestQuery, zLeaveApproval, zLeaveRejection, } from '@shop/shared';
...
import { initLeaveQuota, findLeaveQuotaByFilter, findLeaveQuotaById, updateLeaveQuota, LeaveQuotaError, } from '../services/leave-quota.service.js';
import { createLeaveRequest, findLeaveRequestByFilter, findLeaveRequestById, updateLeaveRequest, approveLeaveRequest, rejectLeaveRequest, cancelLeaveRequest, LeaveRequestError, } from '../services/leave-request.service.js';
export const leaveRoutes = async (app) => {
    ...
    app.post('/leave-requests/:id/approve', {
        schema: {
            description: '审批通过',
            tags: ['假期'],
            params: zodToSchema(z.object({ id: z.coerce.number().int().positive() })),
    ...
    app.post('/leave-requests/:id/reject', {
        schema: {
            description: '拒绝申请',
            tags: ['假期'],
            params: zodToSchema(z.object({ id: z.coerce.number().int().positive() })),
    ...
    app.post('/leave-requests/:id/cancel', {
        schema: {
            description: '取消申请',
            tags: ['假期'],
            params: zodToSchema(z.object({ id: z.coerce.number().int().positive() })),
